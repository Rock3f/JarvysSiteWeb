...
var henryDes = '<div><img id="backgroundModalLise" class="backgroundModal" src="{{ url_for(\'static\', filename=\'images/salt.jpg\') }}"/> <img class="profileModal" src="{{ url_for(\'static\', filename=\'images/henry_maisonneuve.jpg\') }}"/></div><div class="contentModal"> <h3>Henry Maisonneuve</h3><p><span class="bold">Son rôle :</span> Henry est un concepteur développeur IONIC. Il s\'occupe de la réalisation de l\'application mobile. </p><p> <span class="bold">Ses passions :</span> Mathias et Monster Hunter World</p><p><span class="bold">Verseau ascendant Vierge</span>, il ne peut résister aux digimons.</p></div>';
